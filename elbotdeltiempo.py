...
def calidadAire(bot, update):
    user = getUser(bot, update)
    html_page = urllib2.urlopen("http://servicios.jcyl.es/esco/datosTiempoReal.action?provincia=" + municipiosCalidadAire[user[municipio]]["provincia"] + "&estacion=" + municipiosCalidadAire[user[municipio]]["value"] + "&tamanoPagina=50&consultar=1")
